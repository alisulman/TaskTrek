            ...
            <div className="flex flex-col justify-center font-[sans-serif] sm:h-screen p-4 bg-white">
                <div className="max-w-md w-full mx-auto border border-gray-300 rounded-2xl p-8">
                    ...
                    <form>
                        ...
                        <p className="text-gray-800 text-sm mt-6 text-center">Don&apos;t have an account? <Link href="/signup" className="text-blue-600 font-semibold hover:underline ml-1">Signup here</Link></p>
                    </form>
                </div>
            </div>
        </>
